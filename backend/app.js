...
const optimointiSaannotRouter = require('./routes/optimointiSaannot')
...
const leaditRouter = require('./controllers/leadit')
const tyomaaraKommentitRouter = require('./controllers/tyomaaraKommentit')
...
// Tuonti (POST /api/kurssit/tuonti) voi lähettää suuren JSONin; oletus ~100 kt aiheuttaa 413 Payload Too Large
...
app.use('/api/tyomaara-kommentit', middleware.flexUserExtractor, tyomaaraKommentitRouter)
...
app.use('/api/optimointi-saannot', middleware.flexUserExtractor, optimointiSaannotRouter)
app.use('/api/kayttaja', kayttajaAuthRouter)
app.use('/api/leadit', leaditRouter)
